<template lang="html">
  <div class="about" v-loading="loading2" element-loading-text="加载中">
    <div v-if="shows">
      ...
      <p><a href="https://github.com/lijinzhuang" target="_blank">Github</a>&nbsp;&nbsp;<a href="https://www.xue37.com">拣书</a><a href="http://blog.csdn.net/buzaiQQ">CSDN</a></p>
      <h2>关于网站</h2>
      ...
      <p>本人并非专业前端工程师，因此参考了 "<a href="https://github.com/elva2596" target="_blank">Github</a>"，仅做了部分样式调整，换成自己的风格。</p>
    </div>
  </div>
</template>
